...
begin
    ...
    diagnostic = (
        course_unit = "ch16-advanced-optimal-control",
        status = "complete",
...
A capacity constraint of the form `I(t) <= Imax` can be added the same way, and
is worth trying: if the cap sits above what the case-minimising policy already
achieves it changes nothing, and if it sits below, total cases rise.
"""
...
manifest_format = "2.0"
project_hash = "c970b2827620eaffe2662fb77ab3f596cc89544a"
...
[[deps.InfiniteOpt]]
deps = ["DataStructures", "Distributions", "FastGaussQuadrature", "JuMP", "LinearAlgebra", "MutableArithmetics", "Reexport"]
git-tree-sha1 = "1de25880307cf31b49debcb2bc8f02899cc2a8d3"
uuid = "20393b10-9daf-11e9-18c9-8db751c92c57"
version = "0.6.3"

    [deps.InfiniteOpt.extensions]
    InfiniteInterpolations = "Interpolations"
    InfiniteMathOptAI = "MathOptAI"

    [deps.InfiniteOpt.weakdeps]
