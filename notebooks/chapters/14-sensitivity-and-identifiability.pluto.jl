...
begin
    ...
    # Course baseline constants, inlined so this notebook carries its own
    # environment. They match EpiModelingCourse's defaults.
    const N10 = 1000.0
    const u010 = [990.0, 10.0, 0.0]
...
begin
    ...
    (
        course_unit = "ch14-sensitivity-and-identifiability",
        status = "complete",
