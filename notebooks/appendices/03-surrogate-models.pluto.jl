...
begin
    # sir_ode! previously came from EpiModelingCourse; inlined here so the
    # notebook carries its own environment. Transmission is beta * contact_rate.
    function sir_ode!(du, u, p, t)
        incidence = p.beta * p.contact_rate * u[1] * u[2] / p.N
        du[1] = -incidence
        du[2] = incidence - p.gamma * u[2]
        du[3] = p.gamma * u[2]
        return nothing
    end
    ...
    function recovered_fraction(β)
        p = (beta = β, contact_rate = 10.0, gamma = 0.25, N = 1000.0)
...
begin
    ...
    validation = (
        course_unit = "a03-surrogate-models",
        status = "complete",
...
manifest_format = "2.0"
project_hash = "62efed85a3ebd868dd165cb75c903ac58521c444"
...
git-tree-sha1 = "920cd2ca528bb2c298ff717930e52a96de52534a"
...
git-tree-sha1 = "2f55418d0cdf9997862b944a36cfaa82798b909c"
...
[[deps.Surrogates]]
deps = ["ChainRulesCore", "Distributions", "ExtendableSparse", "GLM", "IterativeSolvers", "LinearAlgebra", "PrecompileTools", "QuasiMonteCarlo", "Random", "SparseArrays", "Statistics", "SurrogatesBase", "Zygote"]
git-tree-sha1 = "dca5cc991e6b2dc1699fdb7d3885692971ceaa86"
...
[[deps.SurrogatesBase]]
git-tree-sha1 = "a59a5b42af4fd8f898c14374d2d27eeb8fed7709"
