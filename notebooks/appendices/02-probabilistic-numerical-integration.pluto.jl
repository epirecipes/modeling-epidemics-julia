...
Companion notebook for the `a02-probabilistic-numerical-integration` unit. A
...
begin
    ...
    # Course baseline (EpiModelingCourse.BASELINE_PARAMETERS), inlined so this
    # notebook carries its own environment.
    p = (beta = 0.05, contact_rate = 10.0, gamma = 0.25, N = 1000.0)
    s0 = (S = 990.0, I = 10.0, R = 0.0)
    u0 = [s0.S, s0.I, s0.R]
    tspan = (0.0, 40.0)
...
begin
    ...
    (
        course_unit = "a02-probabilistic-numerical-integration",
        status = "complete",
        controls = (; log_tol, δt),
...
manifest_format = "2.0"
project_hash = "98b8c2b7dc0cf53c432c2442bf3e49a68511408a"
