...
length(solution_paths) == 6 || push!(errors, "Expected 6 solution part files, found $(length(solution_paths)).")
...
length(solution_matches) == 50 || push!(errors, "Expected 50 solution anchors, found $(length(solution_matches)).")
...
println("Course structure is valid: 25 teaching units and 50 exercise/solution pairs.")
